...
function setup() {
  ...
  trex = createSprite(width/2-400,height - 80,20,50);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(touches.length>0||keyDown("space") && trex.y >= 886) {
      trex.velocityY = -12;
      touches = [];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width+10,height-90,40,10);
    cloud.y = Math.round(random(100,480));
